...
Tick_typ_valids_dist_S1_2023 <- ggplot(data = NbValidS1_cleaned, aes(x = CATEGORIE_TITRE, y = NB_VALD)) +
...
# Save the graph as an image file (e.g., ".png", ".jpg")
ggsave("Tick_typ_valids_dist_S1_2023.png", Tick_typ_valids_dist_S1_2023, width = 10, height = 6, units = "in")

# Display the graph
print(Tick_typ_valids_dist_S1_2023)
```
